...
void* check_lru_container_list(struct lruCache* c, int64_t cid);
int32_t check_lru_container_list_without_update(struct lruCache* c, int64_t cid);
...
void* lru_base_container_cache_insert(struct lruCache *c, void* data);
