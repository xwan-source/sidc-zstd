...
/*
 * Fragmented chunks are marked CHUNK_SPARSE, CHUNK_OUT_OF_ORDER, and CHUNK_BASE_FRAGMENTED.
 */
...
/* Output of resemblance detection phase. */
SyncQueue* resemblance_queue;
/* Output of matching phase. */
SyncQueue* matching_queue;
/* Output of delta phase. */
SyncQueue* delta_queue;
/* Output of delta phase. */
SyncQueue* local_compression_queue;
